...
![Xcode Custom iOS Target Properties](/docs/v4/assets/img/guides/first-app-cap-ng/xcode-info-plist.png)
...
![Xcode - Selecting Development Team](/docs/v4/assets/img/guides/first-app-cap-ng/xcode-signing.png)
...
![Xcode build button](/docs/v4/assets/img/guides/first-app-cap-ng/xcode-build-button.png)
...
![iOS Camera permissions](/docs/v4/assets/img/guides/first-app-cap-ng/ios-permissions-photo.png)
...
![Android Manifest location](/docs/v4/assets/img/guides/first-app-cap-ng/android-manifest.png)
...
![Launching app on Android](/docs/v4/assets/img/guides/first-app-cap-ng/android-device.png)
...
![Android Camera permissions](/docs/v4/assets/img/guides/first-app-cap-ng/android-permissions-photo.png)
