...
When planning to deploy an app to desktop, either using <a href="https://electronjs.org" target="_blank">Electron</a> or as a **Progressive Web App**, it is important to ensure the app works smoothly on larger devices.
...
![](/docs/v4/assets/img/building/cross-platform-items.png)
...
![](/docs/v4/assets/img/building/cross-platform-grid.png)
...
![](/docs/v4/assets/img/building/cross-platform-grid-fixed.png)
