...
<aside>
  <docs-card href="/docs/api/header" header="Learn More" icon="/docs/v4/assets/icons/component-header-icon.png">
...
<aside>
  <docs-card href="/docs/api/footer" header="Learn More" icon="/docs/v4/assets/icons/component-footer-icon.png">
